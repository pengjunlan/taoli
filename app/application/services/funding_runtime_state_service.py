"""Runtime state helpers for funding-arbitrage staged execution."""
...
class FundingRuntimeStateService:
    _KEY_PREFIX = "funding:runtime"
...
funding_runtime_state_service = FundingRuntimeStateService()


__all__ = [
    "FundingRuntimeStateService",
    "funding_runtime_state_service",
]
