        ...
        with mysql_manager.connection() as connection:
            ...
            cursor.execute(
                ...
                SET
                    ...
                    open_spread_rate_max_threshold = %s,
                    ...
                    split_order_amount_usdt = %s,
                    funding_open_window_start_minutes = %s,
                    funding_open_window_end_minutes = %s,
                    funding_settlement_skew_minutes = %s,
                    funding_spread_resonance_min = %s,
                    net_spread_threshold = %s,
                    funding_carry_min = %s,
                    max_funding_cost = %s,
                    min_net_profit_threshold = %s,
                    take_profit_threshold = %s,
                    drawdown_add_step_percent = %s,
                    max_hold_minutes = %s,
