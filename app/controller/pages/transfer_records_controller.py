...
from app.views.viewmodels.pages.page_contexts import transfer_records_context
...
async def transfer_records_page(request: Request) -> HTMLResponse:
    ...
    return render_page(request, PAGE, current_user=current_user, **transfer_records_context())
